...
urlpatterns = [
    ...
    path('lista_competencias_linguisticas', views.lista_competencias_linguisticas,
         name='lista_competencias_linguisticas'),
    path('lista_competencias_organizativas', views.lista_competencias_organizativas,
         name='lista_competencias_organizativas'),
